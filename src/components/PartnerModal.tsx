  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("Partnership error:", errorData);
  ...
  return (
    <>
      ...
      <StatusModal
        ...
        message={
          submitStatus === "success"
            ? "Thank you! Your partnership inquiry has been submitted successfully. We'll review your proposal and get back to you within 3-5 business days."
            : "Sorry, there was an error submitting your partnership inquiry. Please try again or contact us directly."
        }
