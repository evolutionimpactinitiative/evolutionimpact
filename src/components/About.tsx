      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex md:flex-row flex-col items-center lg:items-start justify-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:flex-1 lg:max-w-[60%] space-y-8">
            ...
            {/* Large Group Photo */}
            <div className="w-full">
              <div className="relative block md:hidden w-full aspect-[4/3] rounded-lg overflow-hidden bg-gray-200">
                <Image
                  src="/assets/about-right.jpg"
                  alt="Team members at Evolution Impact Initiative"
                  fill
              ...
              <div className="relative hidden md:block w-full aspect-[3/2] rounded-lg overflow-hidden bg-gray-200">
                <Image
                  src="/assets/about-left.jpg"
                  alt="Evolution Impact Initiative team group photo"
                  fill
          ...
          <div className="w-full lg:flex-1 lg:max-w-[40%] flex flex-col">
            ...
            <div className="w-full mt-8 lg:mt-0 order-2 lg:order-1">
              <div className="relative w-full md:hidden block aspect-[3/2] rounded-lg overflow-hidden bg-gray-200">
                <Image
                  src="/assets/about-left.jpg"
                  alt="Evolution Impact Initiative team group photo"
                  fill
              ...
              <div className="relative w-full hidden md:block aspect-[4/3] rounded-lg overflow-hidden bg-gray-200">
                <Image
                  src="/assets/about-right.jpg"
                  alt="Team members at Evolution Impact Initiative"
                  fill
